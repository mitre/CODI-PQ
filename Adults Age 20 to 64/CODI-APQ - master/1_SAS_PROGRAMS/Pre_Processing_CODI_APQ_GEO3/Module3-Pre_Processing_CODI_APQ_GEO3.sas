/*******************************************************************************************/
/***PROGRAM: Module3-Pre-Processing_CODI_APQ_ZCTA3.SAS					 				 ***/
/***VERSION: 1.0																		 ***/
...
Data Imputed_Race_by_Model;
	Set People_Impute_By_Model;
		...
		XBETA_Black=&Intercept_2.+Put(State_ZIP_Model, $STATEZIP_BLACK.)+Put(Sex_Model, $SEX_BLACK.)+(Age_Model*&Age_2.);
		XBETA_Asian=&Intercept_3.+Put(State_ZIP_Model, $STATEZIP_ASIAN.)+Put(Sex_Model, $SEX_ASIAN.)+(Age_Model*&Age_3.);
		XBETA_Other=&Intercept_4.+Put(State_ZIP_Model, $STATEZIP_OTHER.)+Put(Sex_Model, $SEX_OTHER.)+(Age_Model*&Age_4.);
