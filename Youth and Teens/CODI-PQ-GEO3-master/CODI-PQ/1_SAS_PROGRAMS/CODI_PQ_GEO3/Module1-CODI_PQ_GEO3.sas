/*******************************************************************************************/
/***PROGRAM: Module1-CODI_PQ_GEO3.SAS									 				 ***/
/***VERSION: 1.0																		 ***/
...
%Macro CODI_PQ;
	...
	%Let Age_List  = %STR(WGT_AGE_2_4, WGT_AGE_5_9, WGT_AGE_10_14, WGT_AGE_15_17, WGT_AGE_18_19);
	...
	%Let AGE_REQUEST = %Sysfunc(CATS(&WGT_AGE_2_4., &WGT_AGE_5_9., &WGT_AGE_10_14., &WGT_AGE_15_17., &WGT_AGE_18_19.));
	...
	%Build_Query(Request=&AGE_REQUEST.,  Values=&AGE_VALUES.,  Var=Wgt_Age_Categories, Query=AGE);
	...
	%Selection_Fail(Var=Age, 	   Var_List=&WGT_AGE_2_4. &WGT_AGE_5_9. &WGT_AGE_10_14. &WGT_AGE_15_17. &WGT_AGE_18_19.);
	...
	Proc Sql NOPRINT;
		Create table Stacked_Years as
			Select Year, PATID, GEO3, Geography as Geography,
				...
				AGEYR as Age Label = "Age, In Years", Wgt_Age_Categories as Wgt_Age_Categories,
				PREGNANCY_FLAG
	...
	%If &sample_check.=Y %Then %Do;
		Proc Freq Data=User_Select noprint;
			Table Wgt_Age_Categories/list missing Out=Geo_age_cat (Drop=Percent Rename=(Wgt_Age_Categories=Values)); 
	...
	Data Prepped_USER_File;
		Set Prepped_USER_File;
			Label Age_Raking   = "Raking: Age"
				  ...
				  ;
			Orig_Age_Raking   = Wgt_Age_Categories; 			   Age_Raking   = Wgt_Age_Categories;
		...
		%If &Collapse_Pass.=1 %Then %Do;
			...
			%If &Covergence_Pass.=1 %Then %Do;
				...
				%IF &AGE_ADJ.=Y %Then %Do;
					%Age_Adjust(Inds=Weighted_USER_File, Outds=Weighted_USER_File, Inwt=RakeWgt, Outwt=AgeAdjWgt, Age_Var=Wgt_Age_Categories);
				%End;
